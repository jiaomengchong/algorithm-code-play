 ...
 * 有产生如下的二元组(as, soon, 1)、(as soon, as, 1)、(as soon as, possibl
 * 意思是这一个句子产生了如下的统计：
...
public class Code03_AiFill {
    public static class TrieNode {
        private String word;
        private int times;
        private Map<String, TrieNode> nextNodes;
        private TreeSet<TrieNode> nextRanks;
    ...
    public static class AI {
        ...
        private List<String> suggest(String sentence) {
            ...
            for (TrieNode node : cur.nextRanks) {
                ans.add(node.word);
                if (ans.size() == topK) {
                    break;
                }
